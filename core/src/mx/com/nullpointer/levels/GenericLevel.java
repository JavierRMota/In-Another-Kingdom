...
public abstract class GenericLevel extends GenericScreen {
    ...
    //ULTIMATE LEVEL
    protected static final int ULTIMATE_LEVEL = 9;
    //Maps
    ...
    protected void drawLoose()
    {
        ...
        text.showMsg(batch, "Progress: "+String.format("%.0f",laurence.getX()/MAP_WIDTH*100) +"%",WIDTH/2,3*HEIGHT/4,1.5f,'l');
        batch.end();
        looseScene.draw();
    }

    public void disposeGenericLevel()
    {
        //Music
